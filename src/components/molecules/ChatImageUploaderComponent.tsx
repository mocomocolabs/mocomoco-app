...
export type IChatImageUploaderRef = any

export interface ChatImageUploadItem extends File {
  id: number
  preview: string
}

export interface IChatImageUploader {
  images: ChatImageUploadItem[]
  setImages: (imgs: ChatImageUploadItem[]) => void
  refUploader: IChatImageUploaderRef
  className?: string
}
...
export const assignPreview = (v: File, i: number) =>
  ...
  } as ChatImageUploadItem)

export const ChatImageUploader: FC<IChatImageUploader> = ({
  images = [],
  setImages,
  refUploader,
  className,
